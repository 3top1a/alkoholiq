...
pub enum Instruction {
    ...
    ///
    /// Second argument needs to be sorted in descending order, and the cases
    /// instructions must be in the *exact opposite* order of the values in the second argument.
